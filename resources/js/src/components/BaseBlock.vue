<template>
    <component
        ...
        class="block"
    >
        <div :class="classContainerHeader" class="block-header" v-if="$slots.header || $slots.title || title">
            <slot name="header">
                ...
                <div :class="classContainerOptions"
                     class="block-options"
                     v-if="$slots.options || btnOptionFullscreen || btnOptionPinned || btnOptionContent || btnOptionClose">
                    <slot name="options"></slot>
                    <button @click="fullscreenToggle" class="btn-block-option" type="button" v-if="btnOptionFullscreen">
                        <i :class="{'si si-size-fullscreen': !optionFullscreen, 'si si-size-actual': optionFullscreen}"></i>
                    </button>
                    <button @click="pinnedToggle" class="btn-block-option" type="button" v-if="btnOptionPinned">
                        <i class="si si-pin"></i>
                    </button>
                    <button @click="contentToggle" class="btn-block-option" type="button" v-if="btnOptionContent">
                        <i :class="{'si si-arrow-up': !optionContentHide, 'si si-arrow-down': optionContentHide}"></i>
                    </button>
                    <button @click="close" class="btn-block-option" type="button" v-if="btnOptionClose">
                        <i class="si si-close"></i>
                    </button>
                </div>
            </slot>
        </div>
        <div :class="classContainerContent" class="block-content" v-if="!$slots.content">
            <div class="ribbon-box" v-if="this.ribbon">
                <slot name="ribbon">
                    {{ ribbon }}
                </slot>
            </div>
