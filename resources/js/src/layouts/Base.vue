<template>
    <div id="page-container" :class="classContainer">
        <!-- Page Loader -->
        <div id="page-loader" :class="{'show': loader}"></div>
        <!-- END Page Loader -->

        <!-- Page Overlay -->
        <div id="page-overlay" v-if="sideOverlay && pageOverlay" @click="close"></div>
        <!-- END Page Overlay -->

        <!-- Side Overlay -->
        <base-side-overlay v-if="sideOverlay" :class="layoutClasses.sideOverlay || 'font-size-sm'">
            <slot name="side-overlay"></slot>
        </base-side-overlay>
        <!-- END Side Overlay -->

        <!-- Sidebar -->
        <base-sidebar v-if="sidebar" :class="layoutClasses.sidebar">
            <slot name="sidebar"></slot>
        </base-sidebar>
        <!-- END Sidebar -->

        <!-- Header -->
        <base-header v-if="header" :class="layoutClasses.header">
        ...
        <!-- Footer -->
        <base-footer v-if="footer" :class="layoutClasses.footer || 'bg-body-light'">
