<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Multiple style options to match your preferences." title="Table Styles">
            <template #extra>
                ...
                <b-col xl="6">
                    ...
                    <base-block title="Default Table">
                        <b-table-simple responsive table-class="table-vcenter">
                            ...
                            <b-tbody>
                                <b-tr :key="user.id" v-for="user in users.slice(0, 6)">
            ...
            <b-row>
                <b-col xl="6">
                    ...
                    <base-block title="Hover Table">
                        ...
                        <b-table-simple hover responsive table-class="table-vcenter">
                            <b-thead>
                                <b-tr>
                                    <b-th class="text-center" style="width: 50px;">#</b-th>
                                    <b-th>Name</b-th>
                ...
                <b-col xl="6">
                    ...
                    <base-block title="Bordered Table">
                        ...
                        <b-table-simple bordered responsive table-class="table-vcenter">
                            <b-thead>
                                <b-tr>
                                    <b-th class="text-center" style="width: 50px;">#</b-th>
                                    <b-th>Name</b-th>
            ...
            <b-row class="row-deck">
                <b-col xl="6">
                    ...
                    <base-block title="Borderless Table">
                        ...
                        <b-table-simple borderless responsive table-class="table-vcenter">
                            <b-thead>
                                <b-tr>
                                    <b-th class="text-center" style="width: 50px;">#</b-th>
                                    <b-th>Name</b-th>
                ...
                <b-col xl="6">
                    ...
                    <base-block title="Small Table">
                        ...
                        <b-table-simple responsive small table-class="table-vcenter">
                            ...
                            <b-tbody>
                                <b-tr :key="user.id" v-for="user in users.slice(0, 8)">
                                    <b-td class="text-center">
                                        {{ user.id }}
                                    </b-td>
                                    <b-td class="font-w600 font-size-sm">
            ...
            <b-row>
                ...
                <b-col>
                    ...
                    <base-block title="Contextual Table">
                        <b-table-simple borderless hover responsive table-class="table-vcenter">
                            <b-thead>
                                <b-tr>
                                    <b-th class="text-center" style="width: 50px;">#</b-th>
                                    <b-th>Name</b-th>
                            ...
                            <b-tbody>
                                <b-tr :key="user.id" :variant="user.rowVariant" v-for="user in users">
                                    <b-td class="text-center">
                                        {{ user.id }}
                                    </b-td>
                                    <b-td class="font-w600 font-size-sm">
