<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Clean and responsive pricing tables that will improve your conversions."
        ...
        <div class="content">
            ...
            <b-row>
                <b-col md="6" xl="3">
                    <!-- Developer Plan -->
                    <base-block class="text-center" href="javascript:void(0)" link-shadow tag="a" title="Developer">
                        <template #content>
                ...
                <b-col md="6" xl="3">
                    <!-- Startup Plan -->
                    <base-block class="text-center" href="javascript:void(0)" link-shadow tag="a" title="Startup">
                        <template #content>
                            <div class="block-content bg-body-light">
                                <div class="py-2">
                ...
                <b-col md="6" xl="3">
                    <!-- Business Plan -->
                    <base-block class="text-center" fx-shadow href="javascript:void(0)" link-shadow tag="a" themed>
                        <template #header>
                ...
                <b-col md="6" xl="3">
                    <!-- VIP Plan -->
                    <base-block class="text-center" href="javascript:void(0)" link-shadow tag="a" title="VIP">
                        <template #content>
                            <div class="block-content bg-body-light">
                                <div class="py-2">
            ...
            <b-row>
                <b-col md="6" xl="3">
                    <!-- Developer Plan -->
                    <base-block class="text-center" href="javascript:void(0)" tag="a" title="Developer">
                        <template #content>
                ...
                <b-col md="6" xl="3">
                    <!-- Startup Plan -->
                    <base-block class="text-center" href="javascript:void(0)" link-rotate tag="a" title="Startup">
                        <template #content>
                ...
                <b-col md="6" xl="3">
                    <!-- Business Plan -->
                    <base-block class="text-center" href="javascript:void(0)" link-shadow tag="a" title="Business">
                        <template #content>
                ...
                <b-col md="6" xl="3">
                    <!-- VIP Plan -->
                    <base-block class="text-center" href="javascript:void(0)" link-pop tag="a" title="VIP">
                        <template #content>
            ...
            <base-block content-class="p-0">
                <b-table-simple borderless hover responsive table-class="table-vcenter text-center mb-0">
                    ...
                    <b-tbody>
                        ...
                        <b-tr class="bg-body-light">
                            <b-td></b-td>
                            <b-td>
                                <button class="btn btn-rounded btn-secondary px-4" type="button">Sign Up</button>
                            </b-td>
                            <b-td>
                                <button class="btn btn-rounded btn-secondary px-4" type="button">Sign Up</button>
                            </b-td>
                            <b-td>
                                <button class="btn btn-rounded btn-primary px-4" type="button">Sign Up</button>
                            </b-td>
                            <b-td>
                                <button class="btn btn-rounded btn-secondary px-4" type="button">Sign Up</button>
                            </b-td>
