<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Customizable and accesible popup boxes powered by SweetAlert2 plugin."
                           title="Dialogs">
            <template #extra>
            ...
            <base-block title="SweetAlert2">
                <b-row class="items-push">
                    <b-col md="6">
                        ...
                        <b-button @click="swalSimple" class="push" variant="light">
                            Launch Dialog
                        </b-button>
                        <!-- END Simple -->
                    </b-col>
                    <b-col md="6">
                        ...
                        <b-button @click="swalSuccess" class="push" variant="light">
                    ...
                    <b-col md="6">
                        ...
                        <b-button @click="swalInfo" class="push" variant="light">
                    ...
                    <b-col md="6">
                        ...
                        <b-button @click="swalWarning" class="push" variant="light">
                    ...
                    <b-col md="6">
                        ...
                        <b-button @click="swalError" class="push" variant="light">
                    ...
                    <b-col md="6">
                        ...
                        <b-button @click="swalQuestion" class="push" variant="light">
                    ...
                    <b-col md="6">
                        ...
                        <b-button @click="swalConfirm" class="push" variant="light">
                    ...
                    <b-col md="6">
                        ...
                        <b-button @click="swalCustomPosition" class="push" variant="light">
