  ...
  <div>
    ...
    <div class="content">
      ...
      <base-block title="HTML">
        ...
        <b-row class="items-push text-center">
          <b-col sm="6" xl="3">
            <b-button size="sm" variant="secondary" block v-b-tooltip.hover.html.nofade.top="'<img class=\'img-avatar\' src=\'images/avatars/avatar10.jpg\' alt=\'\'>'">Top</b-button>
          </b-col>
          <b-col sm="6" xl="3">
            <b-button size="sm" variant="secondary" block v-b-tooltip.hover.html.nofade.right="'<img class=\'img-avatar\' src=\'images/avatars/avatar10.jpg\' alt=\'\'>'">Right</b-button>
          </b-col>
          <b-col sm="6" xl="3">
            <b-button size="sm" variant="secondary" block v-b-tooltip.hover.html.nofade.bottom="'<img class=\'img-avatar\' src=\'images/avatars/avatar10.jpg\' alt=\'\'>'">Bottom</b-button>
          </b-col>
          <b-col sm="6" xl="3">
            <b-button size="sm" variant="secondary" block v-b-tooltip.hover.html.nofade.left="'<img class=\'img-avatar\' src=\'images/avatars/avatar10.jpg\' alt=\'\'>'">Left</b-button>
          </b-col>
        </b-row>
      </base-block>
      <!-- END HTML -->
