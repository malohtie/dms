<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Carefully picked colors that will inspire and make you more productive."
                           title="Color Themes">
            <template #extra>
        ...
        <div class="content">
            ...
            <base-block content-full>
                <b-row class="text-center">
                    <b-col class="py-4" cols="6" xl="2">
                        <a @click.prevent="$store.commit('setColorTheme', { theme: '' })"
                           class="item item-link-pop item-circle bg-default text-white-75 mx-auto mb-3" href="#">
                    ...
                    <b-col class="py-4" cols="6" xl="2">
                        <a @click.prevent="$store.commit('setColorTheme', { theme: 'amethyst' })"
                           class="item item-link-pop item-circle bg-amethyst text-white-75 mx-auto mb-3" href="#">
                            <i class="si si-drop"></i>
                        </a>
                    ...
                    <b-col class="py-4" cols="6" xl="2">
                        <a @click.prevent="$store.commit('setColorTheme', { theme: 'city' })"
                           class="item item-link-pop item-circle bg-city text-white-75 mx-auto mb-3" href="#">
                            <i class="si si-drop"></i>
                        </a>
                    ...
                    <b-col class="py-4" cols="6" xl="2">
                        <a @click.prevent="$store.commit('setColorTheme', { theme: 'flat' })"
                           class="item item-link-pop item-circle bg-flat text-white-75 mx-auto mb-3" href="#">
                            <i class="si si-drop"></i>
                        </a>
                    ...
                    <b-col class="py-4" cols="6" xl="2">
                        <a @click.prevent="$store.commit('setColorTheme', { theme: 'modern' })"
                           class="item item-link-pop item-circle bg-modern text-white-75 mx-auto mb-3" href="#">
                            <i class="si si-drop"></i>
                        </a>
                    ...
                    <b-col class="py-4" cols="6" xl="2">
                        <a @click.prevent="$store.commit('setColorTheme', { theme: 'smooth' })"
                           class="item item-link-pop item-circle bg-smooth text-white-75 mx-auto mb-3" href="#">
                            <i class="si si-drop"></i>
                        </a>
                ...
                <hr>
                <b-row class="text-center">
                    <b-col class="py-4" cols="6" offset-xl="1" xl="2">
                        <base-layout-modifier action="sidebarStyleLight" class="item item-link-pop item-circle bg-sidebar-light text-muted mx-auto mb-3"
                                              tag="a">
                            <i class="si si-drop"></i>
                    ...
                    <b-col class="py-4" cols="6" xl="2">
                        <base-layout-modifier action="sidebarStyleDark" class="item item-link-pop item-circle bg-sidebar-dark text-white-75 mx-auto mb-3"
                                              tag="a">
                            <i class="si si-drop"></i>
                        </base-layout-modifier>
                        <div class="font-w600">Dark Sidebar</div>
                    </b-col>
                    <b-col class="py-4" cols="6" offset-xl="2" xl="2">
                        <base-layout-modifier action="headerStyleLight" class="item item-link-pop item-circle bg-header-light text-muted mx-auto mb-3"
                                              tag="a">
                            <i class="si si-drop"></i>
                        </base-layout-modifier>
                    ...
                    <b-col class="py-4" cols="6" xl="2">
                        <base-layout-modifier action="headerStyleDark" class="item item-link-pop item-circle bg-header-dark text-white-75 mx-auto mb-3"
                                              tag="a">
                            <i class="si si-drop"></i>
                        </base-layout-modifier>
            ...
            <base-block content-full>
                <b-row class="text-center">
                    ...
                    <b-col class="py-4" cols="6" md="4" xl="3">
                ...
                <hr>
                <b-row class="text-center">
                    <b-col class="py-4" cols="6" md="4" xl="2">
