<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Good Typography not only looks good but also reinforces the meaning of the content."
                           title="Typography">
            <template #extra>
        ...
        <div class="content">
            ...
            <b-row>
                <b-col lg="6">
                    <!-- Bold -->
                    <base-block subtitle="(600 - Default)" title="Bold">
                ...
                <b-col lg="6">
                    <!-- Extra Bold -->
                    <base-block subtitle="(700)" title="Extra Bold">
                ...
                <b-col lg="6">
                    <!-- Normal -->
                    <base-block subtitle="(400)" title="Normal">
                ...
                <b-col lg="6">
                    <!-- Light -->
                    <base-block subtitle="(300)" title="Light">
                        <h1 class="font-w400">h1. Title <small>Subtitle</small></h1>
                        <h2 class="font-w400">h2. Title <small>Subtitle</small></h2>
                        <h3 class="font-w400">h3. Title <small>Subtitle</small></h3>
                        <h4 class="font-w400">h4. Title <small>Subtitle</small></h4>
            ...
            <base-block title="Links">
                <b-row>
                    ...
                    <b-col md="4">
                        ...
                        <p>
                            <b-link class="link-fx text-success" href="javascript:void(0)">Success link with effect
                            </b-link>
                        </p>
                        <p>
                        ...
                        <p>
                            <b-link class="link-fx text-warning" href="javascript:void(0)">Warning link with effect
                            </b-link>
                        </p>
                        <p>
                            <b-link class="link-fx text-danger" href="javascript:void(0)">Danger link with effect
                            </b-link>
                        </p>
                    </b-col>
                    <b-col md="4">
