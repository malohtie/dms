<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Group a series of buttons together on a single line." title="Button Groups">
            <template #extra>
        ...
        <div class="content">
            ...
            <base-block title="Vertical">
                ...
                <b-row class="items-push">
                    <b-col sm="6" xl="4">
                        <!-- Default Style -->
                        <b-button-group class="push mr-3" vertical>
                            <b-button variant="primary">Left</b-button>
                            <b-button variant="primary">Middle</b-button>
                            <b-button variant="primary">Right</b-button>
                        </b-button-group>
            ...
            <base-block title="Default">
                ...
                <b-row class="items-push">
                    <b-col md="6" xl="4">
                        <!-- Default Style-->
                        <b-button-toolbar aria-label="Primary Toolbar with button groups" class="mb-2">
                        ...
                        <b-button-toolbar aria-label="Secondary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Info Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Success Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Warning Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Danger Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Dark Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Light Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                    ...
                    <b-col md="6" xl="4">
                        <!-- Alternate Style -->
                        <b-button-toolbar aria-label="Alternate Primary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Alternate Secondary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Alternate Info Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Alternate Success Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Alternate Warning Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Alternate Danger Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Alternate Dark Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Alternate Light Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                    ...
                    <b-col md="6" xl="4">
                        <!-- Outline Style -->
                        <b-button-toolbar aria-label="Outline Primary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Outline Secondary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Outline Info Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Outline Success Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Outline Warning Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Outline Danger Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Outline Dark Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
                        ...
                        <b-button-toolbar aria-label="Outline Light Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2">
            ...
            <base-block title="Sizes">
                ...
                <b-row class="items-push">
                    <b-col lg="6">
                        <b-button-toolbar aria-label="Small Primary Toolbar with button groups" class="mb-2">
                        ...
                        <b-button-toolbar aria-label="Small Alternate Primary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2" size="sm">
                                <b-button variant="alt-primary">1</b-button>
                                <b-button variant="alt-primary">2</b-button>
                                <b-button variant="alt-primary">3</b-button>
                        ...
                        <b-button-toolbar aria-label="Small Outline Secondary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2" size="sm">
                                <b-button variant="outline-secondary">1</b-button>
                                <b-button variant="outline-secondary">2</b-button>
                                <b-button variant="outline-secondary">3</b-button>
                    ...
                    <b-col lg="6">
                        <b-button-toolbar aria-label="Large Primary Toolbar with button groups" class="mb-2">
                        ...
                        <b-button-toolbar aria-label="Large Alternate Secondary Toolbar with button groups"
                                          class="mb-2">
                            <b-button-group class="mr-2 mb-2" size="lg">
                                <b-button variant="alt-secondary">1</b-button>
                                <b-button variant="alt-secondary">2</b-button>
                        ...
                        <b-button-toolbar aria-label="Large Outline Secondary Toolbar with button groups" class="mb-2">
                            <b-button-group class="mr-2 mb-2" size="lg">
                                <b-button variant="outline-secondary">1</b-button>
                                <b-button variant="outline-secondary">2</b-button>
                                <b-button variant="outline-secondary">3</b-button>
            ...
            <base-block title="Icons">
                ...
                <b-button-toolbar aria-label="Icons Toolbar with button groups" class="mb-2">
                    <b-button-group class="mr-2 mb-2">
                ...
                <b-button-toolbar aria-label="Icons Alternate Toolbar with button groups" class="mb-2">
                    <b-button-group class="mr-2 mb-2">
                ...
                <b-button-toolbar aria-label="Icons Outline Toolbar with button groups" class="mb-2">
                    <b-button-group class="mr-2 mb-2">
