<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Easily add cool ribbons to your blocks." title="Ribbons">
            <template #extra>
        ...
        <div class="content">
            ...
            <b-row>
                ...
                <b-col md="6" xl="3">
                    <!-- Bottom Right -->
                    <base-block ribbon ribbon-bookmark ribbon-bottom>
                        <template #ribbon>
                            <i class="far fa-heart"></i>
                        </template>
                        <div class="text-center py-4 push">
                ...
                <b-col md="6" xl="3">
                    <!-- Bottom Left -->
                    <base-block ribbon ribbon-bookmark ribbon-bottom ribbon-left>
                        <template #ribbon>
                            <i class="far fa-heart"></i>
                        </template>
                        <div class="text-center py-4 push">
                ...
                <b-col md="6" xl="3">
                    <!-- Top Left -->
                    <base-block ribbon ribbon-bookmark ribbon-left>
                        <template #ribbon>
                            <i class="far fa-heart"></i>
                        </template>
                        <div class="text-center py-4 push">
