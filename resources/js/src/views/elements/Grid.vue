<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="Smart and super flexible for building awesome interfaces." title="Grid">
            <template #extra>
        ...
        <div class="content">
            ...
            <base-block content-full title="Responsive Utility Classes">
                <p>For faster mobile-friendly development, use these utility classes for showing and hiding content by
                    device via media query.</p>
                <b-table-simple bordered class="text-center mb-0" hover responsive>
                    <b-thead>
                        <b-tr>
                    ...
                    <b-tbody>
                        <b-tr>
                            <b-td colspan="6">
                                Available options for <code>*</code>: <code>inline</code> <code>inline-block</code>
                                <code>block</code> <code>table</code> <code>table-cell</code> <code>flex</code> <code>inline-flex</code>
                            </b-td>
                        </b-tr>
                        <b-tr>
                            <b-td>
