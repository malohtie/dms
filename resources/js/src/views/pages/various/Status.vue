                    ...
                    <b-row class="justify-content-center">
                        <b-col class="py-4" lg="6" md="8" xl="4">
                            ...
                            <div class="d-flex justify-content-between">
                                <b-button size="lg" to="/backend/pages/generic/blank" variant="alt-secondary">
                                    <i class="fa fa-arrow-left mr-1"></i> Dashboard
                                </b-button>
                                <b-button href="javascript:void(0)" size="lg" variant="alt-success">
                                    <i class="fa fa-rss"></i> <span
                                    class="d-none d-sm-inline-block ml-1">Subscribe</span>
                                </b-button>
                            </div>
                            <hr>
