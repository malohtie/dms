            ...
            <div class="hero-inner bg-black-50">
                <div class="content content-full">
                    <b-row class="justify-content-center">
                        <b-col class="py-3 text-center" md="6">
                            <!-- Header -->
                            <div class="push">
                                <router-link class="link-fx font-w700 font-size-h1" to="/">
                                    <span class="text-white">dms</span>
                                </router-link>
                                <p class="font-size-sm text-white-75">Stay tuned! We are working on it and it is coming
                                    soon!</p>
                            </div>
                            <!-- END Header -->
                                ...
                                <b-row class="form-group justify-content-center">
                                    <b-col md="10" xl="6">
                                        ...
                                        <b-input-group class="mb-2">
                                            <b-form-input class="border-0" placeholder="Enter your email.." required
                            ...
                            <!-- Back to Dashboard -->
                            <b-button size="sm" to="/backend/pages/generic/blank" variant="light">
