    ...
    <div>
        ...
        <base-background image="images/photos/photo8@2x.jpg" inner-class="bg-black-50">
            <div class="content content-full text-center">
                <div class="my-3">
                    <img alt="Avatar" class="img-avatar img-avatar-thumb" src="/images/avatars/avatar13.jpg">
                </div>
            ...
            <b-row>
                <b-col md="7" xl="8">
                    ...
                    <ul class="timeline timeline-alt py-0">
                        <li class="timeline-event">
                            ...
                            <base-block class="timeline-event-block" title="Facebook">
                                <template #options>
                        ...
                        <li class="timeline-event">
                            ...
                            <base-block class="timeline-event-block" title="Products">
                                <template #options>
                                    <div class="timeline-event-time block-options-item font-size-sm">
                                        4 hrs ago
                                    </div>
                        ...
                        <li class="timeline-event">
                            ...
                            <base-block class="timeline-event-block" title="Twitter">
                                <template #options>
                                    <div class="timeline-event-time block-options-item font-size-sm">
                                        12 hrs ago
                                    </div>
                        ...
                        <li class="timeline-event">
                            ...
                            <base-block class="timeline-event-block" title="Backup">
                                <template #options>
                                    <div class="timeline-event-time block-options-item font-size-sm">
                                        1 day ago
                                    </div>
                        ...
                        <li class="timeline-event">
                            ...
                            <base-block class="timeline-event-block" title="System">
                                <template #options>
                                    <div class="timeline-event-time block-options-item font-size-sm">
                                        1 week ago
                                    </div>
                ...
                <b-col md="5" xl="4">
                    ...
                    <base-block header-bg>
                        ...
                        <div class="text-center push">
                            <button class="btn btn-sm btn-light" type="button">Load More..</button>
                        </div>
                    </base-block>
                    <!-- END Followers -->
                </b-col>
