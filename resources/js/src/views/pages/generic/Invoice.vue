<template>
    <div>
        <!-- Hero -->
        <base-page-heading class="d-print-none" subtitle="Clean and professional design." title="Invoice">
            <template #extra>
        ...
        <div class="content content-boxed">
            ...
            <base-block title="#INV0625">
                <template #options>
                    <button @click="printPage" class="btn-block-option" type="button">
                ...
                <div class="p-sm-4 p-xl-7">
                    ...
                    <b-table-simple bordered responsive table-class="table-vcenter">
                        ...
                        <b-tbody>
                            ...
                            <b-tr>
                                <b-td class="font-w600 text-right" colspan="4">Subtotal</b-td>
                                <b-td class="text-right">$27.500,00</b-td>
                            </b-tr>
                            <b-tr>
                                <b-td class="font-w600 text-right" colspan="4">Vat Rate</b-td>
                                <b-td class="text-right">20%</b-td>
                            </b-tr>
                            <b-tr>
                                <b-td class="font-w600 text-right" colspan="4">Vat Due</b-td>
                                <b-td class="text-right">$5.500,00</b-td>
                            </b-tr>
                            <b-tr>
                                <b-td class="font-w700 text-uppercase text-right bg-body-light" colspan="4">Total Due
                                </b-td>
