<template>
    <div>
        <!-- Hero -->
        <base-page-heading subtitle="All pages in one spot!" title="Authentication">
            <template #extra>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <router-link to="/auth/signin" v-slot="{ href, navigate }">
                        <base-block :href="href" @click="navigate" content-class="text-center" link-shadow rounded
                                    tag="a">
                            <div class="py-5">
                                <div class="mb-3">
