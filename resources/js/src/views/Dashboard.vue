            ...
            <div class="content content-narrow content-full">
                <div
                    ...
                    <div class="mt-3 mt-sm-0 ml-sm-3">
                        <b-button class="px-4 py-2" href="javascript:void(0)" v-click-ripple variant="primary">
        ...
        <div class="content content-narrow">
            ...
            <b-row>
                <b-col cols="6" lg="6" md="3" xl="3">
                    <base-block class="border-left border-primary border-4x" content-full href="javascript:void(0)" link-pop rounded
                                tag="a">
                    ...
                    <base-block header-bg title="Earnings in $">
                        ...
                        <template #content>
                            <div class="block-content p-0">
                                <div class="pt-3">
                                    <chartjs-line :chart-data="chartjsEarningsData" :options="chartjsEarningsOptions"
                                                  :styles="chartjsStyles"></chartjs-line>
                                </div>
                            </div>
                ...
                <b-col lg="6">
                    ...
                    <base-block header-bg title="Sales">
                        ...
                        <template #content>
                            <div class="block-content p-0">
                                <div class="pt-3">
                                    <chartjs-line :chart-data="chartjsSalesData" :options="chartjsSalesOptions"
                                                  :styles="chartjsStyles"></chartjs-line>
                                </div>
                            </div>
                            <div class="block-content">
                        ...
                        <b-table-simple borderless class="table-vcenter font-size-sm mb-0" hover striped>
                            <b-thead>
                                <b-tr>
                                    ...
                                    <b-th class="d-none d-lg-table-cell font-w700 text-center" style="width: 100px;">
                                        Photo
                                    </b-th>
                                    <b-th class="font-w700">Name</b-th>
                                    <b-th class="d-none d-sm-table-cell font-w700 text-center" style="width: 80px;">
                                        Orders
                                    </b-th>
                        ...
                        <b-table-simple borderless class="table-vcenter font-size-sm mb-0" hover striped>
                            <b-thead>
                                <b-tr>
                                    ...
                                    <b-th class="d-none d-sm-table-cell font-w700 text-right" style="width: 120px;">
                                        Total
                                    </b-th>
                                    <b-th class="font-w700 text-center" style="width: 60px;"></b-th>
                                </b-tr>
